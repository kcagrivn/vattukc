...
interface ProductDetailPageProps {
  params: {
    slug: string; // Tên slug của sản phẩm
  };
}

// THÊM TỪ KHÓA 'async' VÀO ĐỊNH NGHĨA HÀM để sửa lỗi cú pháp
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="border-t pt-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button className="flex items-center justify-center rounded-full bg-green-600 px-6 py-3 text-lg font-bold text-white shadow-lg transition-colors duration-300 hover:bg-green-700">
